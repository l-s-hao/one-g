...
export default function SolutionsPage() {
  return <div className={styles.page}><div className={styles.container}>
    ...
    <section className={styles.cta}><h2>标准方案无法满足需求？</h2><div className={styles.actions}><Link href="/deep-customization">深度定制</Link><Link href="/configure">查看标准配置</Link></div></section>
  </div></div>;
}
