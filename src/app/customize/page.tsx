...
import { getCustomizeEntry, getCustomizeQuery, type CustomizeScene, type CustomizeScope } from "@/data/customize-entry";
...
function CustomizeWorkbench({ scene, scope }: { scene?: CustomizeScene; scope?: CustomizeScope }) {
  ...
  return (
    ...
    <form autoComplete="off" onSubmit={event => event.preventDefault()} className={styles.page} data-mobile-tab={mobileTab}>
      ...
      <div className={styles.workspace}>
        ...
        <aside id="workbench-summary" className={styles.summaryPanel} aria-label="配置清单与价格">
      ...
      <dialog ref={confirmationRef} className={styles.recommendationDialog} aria-labelledby="recommendation-confirm-title" aria-describedby="recommendation-confirm-description">
