...
import { getProductBySlug, getProducts, getCategoryName, getProductStatusLabel } from "@/lib/products";
...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }): Promise<Metadata> {
  ...
  return {
    title: `${product.name} — ${product.subtitle} · ${getProductStatusLabel(product.status)}`,
    description: `${product.description} ${product.detail.statusNote}`,
    alternates: { canonical: `https://l-s-hao.github.io/one-g/products/${product.slug}/` },
