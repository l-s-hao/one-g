...
export default function AdminPage() {
  ...
  return <div className={styles.dashboard}>
    ...
    <section className={styles.themeSection} aria-labelledby="admin-theme"><h2 id="admin-theme">外观与显示辅助</h2><p className={styles.muted}>仅影响当前管理员自己的界面，不改变全站默认或其他用户的主题。</p><ThemeSelector /></section>
